...
Server.prototype = {
    ...
    initializers: function (callback) {
        var self         = this;
    ...
    start: function (callback) {
        ...
        if (self.initialized === false) {
            self.initializers(function (error) {
                if (error) {
            ...
            var port = (_.isNumber(self.port)) ? self.port : Server.DEFAULT_PORT;
            var host = (_.isString(self.host)) ? self.host : Server.DEFAULT_HOST;
